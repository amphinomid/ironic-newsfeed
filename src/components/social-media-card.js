            ...
            return (
                <Col>
                    <Link to="/comments" style={{ textDecoration: `none` }}>
                        <div id="white-card">
                            <p style={{ fontSize: `1rem`, margin: `10px 15px 0 15px`, overflow: `hidden`, color: `#E04343`, textAlign: `right` }}>
                            ...
                            <div style={{ height: `85px`, display: `flex`, flexDirection: `column` }}>
                                <p style={{ fontSize: `1rem`, margin: `10px 15px 0 15px`, overflow: `hidden`, color: `#E04343` }}>
                                    <b>{generatePhrase()}</b>
                                </p>
                                <p style={{ fontSize: `0.9rem`, alignSelf: `end`, marginLeft: `15px`, marginTop: `auto`, marginBottom: `15px`, overflow: `hidden`, color: `#E04343` }}>
                                    {generateTime()}
                                </p>
                            </div>
                        </div>
